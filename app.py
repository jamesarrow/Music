...
# Критерии оценки
criteria = ["Живой вокал", "Стилевость/Трендовость", "Костюмы", "Оформление сцены", "Харизма артиста", "Номер", "Общее впечатление"]
...
# Одна кнопка с проверкой чекбокса
